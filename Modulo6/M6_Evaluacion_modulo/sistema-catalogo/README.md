# Sistema Catálogo - REST API con JWT
...
Mi nombre es **Nicolas Ariel** y este repositorio contiene el desarrollo del **Sistema Catálogo**, una aplicación API REST que gestiona acceso de usuarios por roles, operaciones CRUD con productos e implementa medidas de seguridad robustas mediante autenticación JWT (JSON Web Token) y BCrypt para el cifrado de contraseñas.

La aplicación está construida con **Spring Boot 3.5.7**, utiliza **Spring Security** para control de acceso basado en roles, y proporciona tanto una interfaz web completa con **JSP y Bootstrap** como endpoints REST para integración con aplicaciones externas.

---

## Características Principales

- **Interfaz web completa**: Vistas JSP con Bootstrap 5 para gestión visual
...
- **API Tester integrado**: Mini-Postman JSP para pruebas de endpoints
- **Documentación OpenAPI**: Especificación estándar sin dependencias externas
- **Doble interfaz**: Web JSP + REST API para máxima flexibilidad
